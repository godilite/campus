...
import 'package:camp/views/messaging/widgets/loading.dart';
...
class ChatScreenState extends State<ChatScreen> {
  ...
  BubbleStyle styleOthers = BubbleStyle(
  ...
  void onSendMessage(String content, int type) {
    ...
    if (content.trim() != '') {
      ...
      _userService.storeChat(peerCode, content);
                  ...
                  child: Bubble(
                    style: BubbleStyle(
                      ...
                      margin: BubbleEdges.only(
                          top: 8.0,
                          left: 50.0,
                          bottom: isLastMessageRight(index) ? 20.0 : 10),
                      alignment: Alignment.topRight,
                    ),
                    child: Text(
